# admin Service Helm Chart

This Helm chart deploys the Shop admin service to a Kubernetes cluster.
...
helm install admin . --namespace shop --create-namespace
```

## Uninstalling the Chart

To uninstall/delete the `admin` release:

```bash
helm delete admin --namespace shop
```
...
| `deploy.image.repository` | Image repository | `registry.gitlab.com/shortlink-org/shop/admin` |
