...
System_Boundary(sbs, "Shop Boundary Context") {
    ...
    System(delivery_graphql, "Delivery-GraphQL", "GraphQL subgraph for delivery (couriers, random address) via Cosmo Connect.")
...
Rel(wundergraph_bff, delivery_graphql, "Delivery queries (randomAddress, couriers) via", "GraphQL")
...
Rel(delivery_graphql, delivery_service, "Calls Delivery API via", "gRPC")
...
System_Boundary(sbs, "Shop Boundary Context") {
    ...
    Container(delivery_graphql, "Delivery-GraphQL", "Service", "GraphQL subgraph for delivery (couriers, random address) via Cosmo Connect gRPC.")
...
Rel(wundergraph_bff, delivery_graphql, "Delivery queries via", "GraphQL")
