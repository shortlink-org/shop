...
- **Feed Service:** Generates product feeds for external marketplaces and aggregators. Implemented in Go,
this service exports goods data in various formats (XML, JSON) for integration with external platforms.
